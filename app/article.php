            ...
            <div class="article__wrapper wrapper">
                <div class="article__container">
                    <div class="article__column-1">
                        <a href="./blog-page.php" class="article__link-back">
                    ...
                    <div class="article__column-2">
                        ...
                        <div class="article__image" style="background: urL(./img/blog-page/<?= $art['image']; ?>) center center no-repeat; background-size: cover;"></div>
