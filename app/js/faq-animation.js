...
faqBtn.forEach((faqButton) => {
  faqButton.children[1].style.transform = 'rotate(0deg)';
  faqButton.addEventListener('click', (e) => {
    // hideNotActiveTab();

    faqButton.nextElementSibling.classList.toggle('faq__answer--animated');
    faqButton.children[1].style.transform =
      faqButton.children[1].style.transform == 'rotate(0deg)' ? 'rotate(90deg)' : 'rotate(0deg)';
  });
});
